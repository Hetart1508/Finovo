...
type AuthRegisterCardProps = {
  ...
  onVerifyRegisterOtp: (event: FormEvent<HTMLFormElement>) => void;
  onEditDetails: () => void;
  onResendOtp: () => void;
  ...
  return (
    <Card className="relative z-0 w-full rounded-xl border-[#E5E7EB] bg-white shadow-[0_16px_40px_rgba(31,41,55,0.08)] dark:border-[#334155] dark:bg-[#111827]">
      {registerStep === 'details' ? (
        ...
        <form onSubmit={onVerifyRegisterOtp}>
          <CardHeader className={cardHeaderClass}>
          ...
          <CardContent className={cardContentClass}>
            ...
            <div className="flex items-center justify-between text-sm text-[#6B7280]">
              ...
              {resendTimer > 0 ? (
                ...
                <button type="button" onClick={onResendOtp} className="font-semibold text-[#34C759] underline hover:text-[#34C759]">
                  Resend OTP
                </button>
              )}
            </div>
