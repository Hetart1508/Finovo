...
const endpoints = [
  ...
  { module: 'ai-advisor', method: 'get', path: '/api/ai-advisor/sessions' },
  { module: 'ai-advisor', method: 'post', path: '/api/ai-advisor/sessions' },
  { module: 'ai-advisor', method: 'delete', path: '/api/ai-advisor/sessions/:sessionId' },
  { module: 'ai-advisor', method: 'get', path: '/api/ai-advisor/messages' },
  { module: 'ai-advisor', method: 'post', path: '/api/ai-advisor/chat' },
  { module: 'ai-advisor', method: 'delete', path: '/api/ai-advisor/messages' },
